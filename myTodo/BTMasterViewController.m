...
@property (nonatomic, strong) BTDetailViewController *detailViewController;
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (BTDetailViewController*)[[self.splitViewController.viewControllers lastObject]topViewController];
}
...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:@"Neues ToDo" forKey:@"title"];
    [newManagedObject setValue:[NSDate date] forKey:@"timestamp"];
    [newManagedObject setValue:[NSDate date] forKey:@"creationDate"];
    [newManagedObject setValue:@"Geben Sie hier eine Beschreibung ein" forKey:@"text"];
    [newManagedObject setValue:@"Unbekannter Ort" forKey:@"location"];
